...
The first thing we found interesting is we found how peoples happiness changed before and after Covid-19 another thing we found intruiging is how countries GPT per capita affects how many covid cases there are. We can extract how a nation's corruption level affects its GDP per capita and hence its covid cases (provided they are related). 
