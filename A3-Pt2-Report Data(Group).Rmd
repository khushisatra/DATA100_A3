...
2. This helps recognize which countries are mutual between the two datasets, and therefore we do not have any missing data per country due to merging
...
4. The plot that we made thus combined 
