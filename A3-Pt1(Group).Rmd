...
# YOUR CODE HERE
  aware_pop <- 
  inner_join(aware_fixed_country, pop_data, by = "country" )|>
...
aware_covid <- aware_pop|>
  inner_join(covid_2020_match_country, by = c("country", "total_population", "aware_no", "aware_alittle", "aware_moderate", "aware_alot","aware_refuse" ))|>
