...
covid_2020 <- covid_cases|>
  filter(year(date) == 2020 & !is.na(continent))|>
...
right_join(aware_pop, by = "country")
...
aware_covid <- aware_pop|>
  inner_join(covid_2020_match_country, by = c("country", "total_population", "aware_no", "aware_alittle", "aware_moderate", "aware_alot","aware_refuse","aware_base", "iso2c", "iso3c", "date","unit", "obs_status", "footnote", "last_updated" ))|>
...
```{r}
combined_data <- bind_rows(ice_extent_yearly,climate_awareness, cyclones_data)
